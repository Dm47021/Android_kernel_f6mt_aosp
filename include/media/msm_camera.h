...
#define MSM_CAMERA_LED_TORCH 5  /*LGE_CHANGE, added torch mode to distinguish torch and pre-flashing, 2013-06-26, soojong.jin@lge.com */
...
#define MAX_AF_STEPS 60 // LGE_CHANGE, Max input af steps from LG APP, 2013-04-25, hyunuk.park@lge.com
...
#if 1
/* LGE_CHANGE
 * L9II camera bring up for Kitkat
 * 2013-12-05, jinw.kim@lge.com
 */
...
#define CFG_MOVE_FOCUS_MANUAL		  63
#define CFG_MAX                       64
#endif //#if 1
...
/* LGE_CHANGE_S : 2012-09-26 sungmin.cho@lge.com vt camera night mode */
enum msm_v4l2_night_mode {
	MSM_V4L2_NIGHT_MODE_OFF ,
	MSM_V4L2_NIGHT_MODE_ON,
};
/* LGE_CHANGE_E : 2012-09-26 sungmin.cho@lge.com vt camera night mode */
...
/* LGE_CHANGE_E : 2012-10-09 sungmin.cho@lge.com vt camera touch aec */
		int32_t soc_awb_lock;	/*LGE_CHANGE, add awb_lock for soc type, 2013-01-02, kwangsik83.kim@lge.com*/
		int32_t soc_aec_lock;	/*LGE_CHANGE, add aec_lock for soc type, 2013-01-02, kwangsik83.kim@lge.com*/
