...
#ifdef CONFIG_FB_MSM_HDMI_MSM_PANEL /* LGE */
...
static struct clk_lookup msm_clocks_8064[] = {
	...
	CLK_LOOKUP("core_clk",		gsbi2_qup_clk.c,	"qup_i2c.2"), /* LGE */
	...
	CLK_LOOKUP("iface_clk",		gsbi2_p_clk.c,		"qup_i2c.2"), /* LGE */
...
static struct clk_lookup msm_clocks_8960_common[] __initdata = {
	...
	CLK_LOOKUP("core_clk",		gsbi9_qup_clk.c,	"qup_i2c.0"), /* LGE */
...
// gspapa.kim gpio change, gpio_35,36 -> gpio_35,34
	CLK_LOOKUP("core_clk",		gsbi8_uart_clk.c, "msm_serial_hsl.1"), // GSPAPA_IIRC
...
#ifdef CONFIG_LGE_IRRC  // GSPAPA_IRRC
// gspapa.kim gpio change, gpio_35,36 -> gpio_35,34
	CLK_LOOKUP("iface_clk",     gsbi8_p_clk.c,		"msm_serial_hsl.1"), /*LGE_CHANGE L9_2 EVB*/
#else
